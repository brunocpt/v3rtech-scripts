...
declare -A SCRIPT_PATHS=(
  [internet]="/mnt/trabalho/Cloud/Compartilhado/Linux/v3rtech-scripts/utils/fpk-internet.sh"
  [office]="/mnt/trabalho/Cloud/Compartilhado/Linux/v3rtech-scripts/utils/fpk-office.sh"
  [multimidia]="/mnt/trabalho/Cloud/Compartilhado/Linux/v3rtech-scripts/utils/fpk-multimidia.sh"
  [games]="/mnt/trabalho/Cloud/Compartilhado/Linux/v3rtech-scripts/utils/fpk-games.sh"
  [devs]="/mnt/trabalho/Cloud/Compartilhado/Linux/v3rtech-scripts/utils/fpk-devs.sh"
  [system]="/mnt/trabalho/Cloud/Compartilhado/Linux/v3rtech-scripts/utils/fpk-system.sh"
)
...
SCRIPT_TEMP=$(mktemp)
{
  ...
  echo "[ -x /mnt/trabalho/Cloud/Compartilhado/Linux/v3rtech-scripts/utils/fpk-gera-atalhos.sh ] && /mnt/trabalho/Cloud/Compartilhado/Linux/v3rtech-scripts/utils/fpk-gera-atalhos.sh || echo 'Script de geração de atalhos não encontrado ou sem permissão.'"

  echo "echo '===== Removendo atalhos órfãos de aplicativos Flatpak desinstalados...'"
  echo "[ -x /mnt/trabalho/Cloud/Compartilhado/Linux/v3rtech-scripts/utils/fpk-limpa-atalhos-orfãos.sh ] && /mnt/trabalho/Cloud/Compartilhado/Linux/v3rtech-scripts/utils/fpk-limpa-atalhos-orfãos.sh || echo 'Script de limpeza de atalhos órfãos não encontrado ou sem permissão.'"
