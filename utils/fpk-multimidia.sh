#!/bin/bash
# ==============================================================================
# Script: fpk-multimidia.sh
# Versão: 4.0.4
# Data: 2026-02-24
# Objetivo: Instalação de editores e players de multimídia via Flatpak
...
if [ -x /usr/bin/picard ]; then
  ...
  if [ -f "/mnt/trabalho/Cloud/Compartilhado/Linux/config/picard-flatpak-$USER.zip" ]; then
    cp /mnt/trabalho/Cloud/Compartilhado/Linux/config/picard-flatpak-$USER.zip $HOME
    cd $HOME
