...
[Service]
Type=notify
ExecStart=/usr/bin/rclone mount SharepointModal:/ /mnt/LAN/ModalDiretoria --config=$HOME/.config/rclone/rclone.conf --vfs-cache-mode full --allow-other
...
[Service]
Type=notify
ExecStart=/usr/bin/rclone mount SharePointModalProjetosAMA:/ /mnt/LAN/ModalProjetos/AMA --config=$HOME/.config/rclone/rclone.conf --vfs-cache-mode full --allow-other
...
[Service]
Type=notify
ExecStart=/usr/bin/rclone mount SharePointModalProjetosRUI:/ /mnt/LAN/ModalProjetos/RUI --config=$HOME/.config/rclone/rclone.conf --vfs-cache-mode full --allow-other
