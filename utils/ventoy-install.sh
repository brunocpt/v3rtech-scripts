#!/bin/bash
# ==============================================================================
# Script: ventoy-install.sh
# Versão: 4.0.4
# Data: 2026-02-24
# Objetivo: Instalação automatizada do Ventoy no Linux
...
sudo cp /opt/mnt/trabalho/Cloud/Compartilhado/Linux/atalhos/ventoy.svg /opt/ventoy/ 2>/dev/null || true
